...
public class Hyphenator {
    ...
    public static String textToSamples(String text) {
        ...
        text = text.replaceAll(("([" + consonants + "])([ ])([" + consonants + "])([" + allVowels + "])"), "$1- -$3$4");
        ...
        text = text.replaceAll(
                "([" + allVowels + "])([" + consonants + "])([ ])([" + consonants + "])(['])([" + ioVowels + "[и]" + "])",
                "$1$2'$3$4$5$6");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(toLatin.transform(textToSamples("чебуречная с шавермой")));
    }
}
